    ...
    return (
        <section className='sobre-section'>
            <div className='cabecalho-sobre'>
                <h1>Descubra o ABC Divertido</h1>
                <p>Um espaço onde aprendizado e diversão caminham juntos, com a participação ativa dos pais.</p>
            </div>

            <div className='descricao-sobre'>
                <h3>O que é o ABC Divertido?</h3>
                <p>O ABC Divertido é uma ferramenta online que utiliza jogos interativos, histórias e atividades 
                lúdicas para ajudar crianças no processo de alfabetização.</p>
            </div>
            
            <div className='info-sobre'>
                <h3>Como Funciona?</h3>
                <p>
                O ABC Divertido transforma o aprendizado em uma experiência lúdica e envolvente, tornando a 
                alfabetização mais leve e prazerosa para as crianças. O site oferece uma variedade de jogos e
                atividades interativas, onde os pequenos podem aprender letras, formar palavras e associar imagens 
                a sons de maneira intuitiva e divertida. As crianças brincam enquanto aprendem, sem sentir 
            ...
            <div className='pais-sobre'>
                ...
                <p>A alfabetização é um momento especial que se torna ainda mais significativo com a participação 
